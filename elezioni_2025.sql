...
--
-- Struttura della tabella `VotiVandidato`
--

CREATE TABLE `VotiVandidato` (
  `ID_voto` int(11) NOT NULL,
  `ID_candidato` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dump dei dati per la tabella `VotiVandidato`
--

INSERT INTO `VotiVandidato` (`ID_voto`, `ID_candidato`) VALUES
(2, 14),
(2, 16),
(3, 35),
(3, 36),
...
--
-- Trigger `VotiVandidato`
--
DELIMITER $$
CREATE TRIGGER `votazioneCandidato` AFTER INSERT ON `VotiVandidato` FOR EACH ROW BEGIN
...
--
-- Indici per le tabelle `VotiVandidato`
--
ALTER TABLE `VotiVandidato`
...
--
-- Limiti per la tabella `VotiVandidato`
--
ALTER TABLE `VotiVandidato`
